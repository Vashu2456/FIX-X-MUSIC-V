...
❖  𝙄 𝙃𝘼𝙑𝙀 𝙎𝙊𝙈𝙀 𝙎𝙀𝘾𝙍𝙀𝙏𝙎 𝙁𝙀𝘼𝙏𝙐𝙍𝙀𝙎                                                                     |------------------------------------------------------------------| 
✧ 𝙄 𝙂𝙄𝙑𝙀 𝙔𝙊𝙐 𝙂𝘼𝙍𝙀𝙏𝙔 -  
✧ 𝙉𝙊 𝙇𝘼𝙂𝙎 ✅ 
 ✧ 𝙉𝙊 𝙄𝙎𝙎𝙐𝙀  ✅ 
✧ 𝙉𝙊 𝙋𝙍𝙊𝘽𝙇𝙀𝙈 𝘾𝙍𝙀𝘼𝙏𝙄𝙉𝙂 ✅ 
✧ 𝘽𝙊𝙏 𝙎𝙏𝘼𝙍𝙏𝙄𝙉𝙂 𝙏𝙄𝙈𝙀 𝙇𝙄𝙈𝙄𝙏 000000 ✅ 
✧ 𝘽𝙊𝙏 𝙎𝙏𝘼𝙍𝙏𝙄𝙉𝙂 𝙏𝙄𝙈𝙀 [24++++++] 𝙃𝙊𝙐𝙍𝙎 ✅ 
✧ 𝙈𝙔 𝙒𝙄𝙎𝙃 𝙔𝙊𝙐 𝙈𝘼𝙆𝙀 𝙈𝙔 𝙁𝙍𝙄𝙀𝙉𝘿 {+} ✅ 
|------------------------------------------------|  
❖ 𝙈𝙔 𝙎𝙊𝙈𝙀 𝙉𝙊𝙍𝙈𝘼𝙇𝙎 𝙁𝙀𝘼𝘾𝙏𝙐𝙍𝙀𝙎  
 |---------------------------|  
✧ 𝘾𝙍𝙀𝘼𝙏𝙄𝙉𝙂 𝙔𝙊𝙐𝙍 𝙊𝙒𝙉 𝘽𝙊𝙏𝙎 𝙀𝘼𝙎𝙄𝙇𝙔
 ✧ 𝐀𝐋𝐋 𝐈𝐍 𝐎𝐍𝐄 
 ✧ 𝙎𝙋𝙀𝘾𝙄𝘼𝙇 𝙒𝙀𝙇𝘾𝙊𝙈𝙀 
✧ 𝘾𝙇𝙊𝙉𝙀 𝘼𝙉𝘿 𝘾𝙍𝙀𝘼𝙏𝙀 𝙔𝙊𝙐𝙍 𝙊𝙉 𝘽𝙊𝙏𝙎 
